        ...
        <div className="max-w-7xl mx-auto bg-ink/95 backdrop-blur-md rounded-full px-6 py-3 flex items-center justify-between shadow-lg shadow-black/10 border border-white/10">
          ...
          <div className="flex items-center space-x-4">
            {token ? (
              ...
              <a href={process.env.NODE_ENV === 'production' ? 'https://tavika-backend-production.up.railway.app/auth/login' : 'http://localhost:8000/auth/login'} className="hidden sm:inline-block text-sm font-medium text-white/70 hover:text-white px-3 py-2 transition-colors">
                Iniciar sesión
              </a>
            )}
